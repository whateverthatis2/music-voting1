...
GRAPH_V8: Dict = {
    "subsystems": [
        ...
        },
        {
            ...
            # PDF Лаб.5 фіг.2: з 13 виходять 3 стрілки (14, 11, 12),
            # з 14 — одна (10), з 11 — одна (12). Усього 5 ребер.
            "edges": [(13, 14), (13, 11), (13, 12), (14, 10), (11, 12)],
        },
    ],
    ...
    "layout": {
        ...
        7:  (6.0, 2.5),
        8:  (6.0, 4.0),
        # підсистема 3 (X 8.0..10.0) — симетрично навколо x=9
        13: (9.0, 0.5),
        14: (8.0, 2.0),
        11: (10.0, 2.0),
        10: (8.0, 3.5),
